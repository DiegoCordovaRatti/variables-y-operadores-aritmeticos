...
document.write(`<p>el resultado de su suma es: <strong> ${suma} </strong></p>`)
document.write(`<p>el resultado de su resta es: <strong> ${resta} </strong></p>`)
document.write(`<p>el resultado de su multiplicación es: <strong> ${multiplicacion} </strong></p>`)
document.write(`<p>el resultado de su división es: <strong> ${division} </strong></p>`)
document.write(`<p>el resultado de su modulo es: <strong> ${modulo} </strong></p>`)
